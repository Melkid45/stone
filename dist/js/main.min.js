...
function monitorPerformance() {
    ...
    if (now - lastTime >= 1000) {
        ...
        if (fps < 30) {
            // Автоматически упрощаем анимации при низком FPS
        }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ====== Генерация постера из src (только десктоп) ======
    const generatedPosters = new Map(); // src -> dataURL
    ...
    // ====== Применить постер к видео (только десктоп) ======
    ...
    function initVideosForItem(item) {
        ...
        videos.forEach(video => {
            ...
            // Присваиваем src только если его нет
            if (!video.src && src) {
                video.src = src;
    ...
    $('.information-tags-tag').on('click', function () {
        ...
        videos.forEach((vid, i) => {
            ...
            if (i === index) {
                ...
                // Загружаем видео через source, если еще нет src
                if (!vid.src && src) {
                    vid.src = src;
