...
document.addEventListener('DOMContentLoaded', function () {
    ...
    workItems.forEach(item => {
        ...
        videos.forEach((vid, i) => {
            vid.pause();
            vid.currentTime = 0;
            if (i === 0) vid.classList.add('show-video');
            else vid.classList.remove('show-video');
        });
        ...
        workItems.forEach(item => {
            ...
            videos.forEach(video => {
                ...
                if (source && source.dataset.src) {
                    if (video.dataset.fallback) video.setAttribute("poster", video.dataset.fallback);
