...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ====== Генерация постера из src ======
    function generatePoster(src) {
        return new Promise((resolve, reject) => {
            if (generatedPosters.has(src)) {
                return resolve(generatedPosters.get(src));
            }
        ...
        videos.forEach(video => {
            ...
            if (src) {
                if (loadedVideos.has(src)) {
                    video.src = loadedVideos.get(src).src;
                } else {
                    video.src = src;
