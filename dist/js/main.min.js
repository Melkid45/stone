...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const videoLoadedMap = {}; // ключ = data-src, значение = true/false
    ...
    workItems.forEach(item => {
        ...
        videos.forEach(video => {
            ...
            // Загружаем видео только один раз по src
            if (!videoLoadedMap[source.dataset.src]) {
                source.src = source.dataset.src;
                video.load();
                videoLoadedMap[source.dataset.src] = true;
        ...
        if (!isTouch) {
            item.addEventListener('mouseenter', () => playVideo(activeVideo));
            item.addEventListener('mouseleave', () => pauseVideo(activeVideo));
        }
    });
